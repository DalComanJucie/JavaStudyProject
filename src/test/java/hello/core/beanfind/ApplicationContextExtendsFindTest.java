...
public class ApplicationContextExtendsFindTest {
    ...
    @Test
    @DisplayName("부모 타입으로 조회시 , 자식 둘 이상 있어면, 중복 오류가 발생한다")
    ...
    @Test
    @DisplayName("부모 타입으로 조회시 , 자식 둘 이상 있어면, 빈 이름을 지정하면 된다")
    ...
    @Test
    @DisplayName("부모 타입으로 모두 조화하기 object")
